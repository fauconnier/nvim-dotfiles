...
function! vimtex#get_root_dir()
  let mybasedir = vimtex#util#shellescape(b:vimtex.root)
  return mybasedir
endfunction

function! vimtex#get_root_file()
  let mybasefile = vimtex#util#shellescape(b:vimtex.base)
  return mybasefile
endfunction
